...
test.describe('Dashboard Overview', () => {
  ...
  const mockLinks = [
    { id: 'link-1', originalUrl: 'https://example.com/1', slug: 'link-1', shortUrl: 'http://localhost:3000/link-1', createdAt: new Date().toISOString(), status: 'ACTIVE', clicks: 50 },
    { id: 'link-2', originalUrl: 'https://example.com/2', slug: 'link-2', shortUrl: 'http://localhost:3000/link-2', createdAt: new Date().toISOString(), status: 'ACTIVE', clicks: 30 }
  ];
