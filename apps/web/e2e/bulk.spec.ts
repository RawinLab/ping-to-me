...
test.describe('Bulk Link Management', () => {
  const mockLinks = [
    { id: 'link-1', originalUrl: 'https://example.com/1', slug: 'link-1', shortUrl: 'http://localhost:3000/link-1', createdAt: new Date().toISOString(), status: 'ACTIVE' },
    { id: 'link-2', originalUrl: 'https://example.com/2', slug: 'link-2', shortUrl: 'http://localhost:3000/link-2', createdAt: new Date().toISOString(), status: 'ACTIVE' },
    { id: 'link-3', originalUrl: 'https://example.com/3', slug: 'link-3', shortUrl: 'http://localhost:3000/link-3', createdAt: new Date().toISOString(), status: 'ACTIVE' }
  ];
  ...
  test('BULK-001: Import Links via CSV', async ({ page }) => {
    ...
    const csvContent = 'originalUrl,slug\nhttps://google.com,google\nhttps://bing.com,bing';
