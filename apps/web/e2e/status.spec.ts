...
test.describe('Link Status Control', () => {
  const mockLinks = [
    { id: 'link-1', originalUrl: 'https://example.com/1', slug: 'active-link', shortUrl: 'http://localhost:3000/active-link', createdAt: new Date().toISOString(), status: 'ACTIVE' },
    { id: 'link-2', originalUrl: 'https://example.com/2', slug: 'disabled-link', shortUrl: 'http://localhost:3000/disabled-link', createdAt: new Date().toISOString(), status: 'DISABLED' },
    { id: 'link-3', originalUrl: 'https://example.com/3', slug: 'archived-link', shortUrl: 'http://localhost:3000/archived-link', createdAt: new Date().toISOString(), status: 'ARCHIVED' }
  ];
