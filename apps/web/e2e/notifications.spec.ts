...
test.describe('Notifications', () => {
  const mockNotifications = [
    { id: 'notif-1', type: 'WARNING', title: 'Link Expired', message: 'Link "my-link" has expired', read: false, createdAt: new Date().toISOString() },
    { id: 'notif-2', type: 'INFO', title: 'Welcome', message: 'Welcome to PingToMe!', read: true, createdAt: new Date(Date.now() - 86400000).toISOString() }
  ];
