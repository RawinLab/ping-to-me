        ...
        <Card className="w-full max-w-lg">
          <CardContent className="pt-8 pb-6 text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">{t("linkCreated")}</h2>
            ...
            {createdLink.safetyStatus === 'unsafe' && (
              <Alert variant="destructive">
                ...
                <AlertTitle>{t("safetyWarning")}</AlertTitle>
                <AlertDescription>
                  {t("unsafeUrl")}
                  {createdLink.safetyThreats && createdLink.safetyThreats.length > 0 && (
                    <> {t("threatsDetected", { threats: createdLink.safetyThreats.join(", ") })}</>
                  )}
                </AlertDescription>
              </Alert>
            )}
            ...
            {createdLink.safetyStatus === 'pending' && (
              <Alert>
                ...
                <AlertTitle>{t("safetyCheckPending")}</AlertTitle>
                <AlertDescription>
                  {t("safetyPendingDesc")}
                </AlertDescription>
              </Alert>
              ...
              <CollapsibleTrigger className="w-full">
                <div className="flex items-center justify-between p-5 hover:bg-slate-50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-semibold">{t("linkDetails")}</h2>
                  </div>
                  {linkDetailsOpen ? (
                  ...
                  <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        {slugStatus === 'checking' && (
                          <span className="text-muted-foreground text-sm flex items-center gap-1">
                            <Loader2 className="h-3 w-3 animate-spin" /> {t("checkingAvailability")}
                          </span>
                        )}
                    ...
                    {slugSuggestions.length > 0 && (
                      <div className="bg-slate-50 rounded-lg p-3 space-y-2">
                        <span className="text-sm text-muted-foreground">{t("availableAlternatives")}</span>
              ...
              <CollapsibleTrigger className="w-full">
                <div className="flex items-center justify-between p-5 hover:bg-slate-50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-semibold">{t("sharingOptions")}</h2>
                  </div>
                  {sharingOptionsOpen ? (
                    <ChevronUp className="h-5 w-5 text-muted-foreground" />
                  ) : (
                ...
                <div className="px-5 pb-5 space-y-4 border-t pt-5">
                  ...
                  <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium">{t("generateQrCode")}</p>
                        <p className="text-sm text-muted-foreground">
                          {t("generateQrDesc")}
                        </p>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between py-2">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium">{t("addToBioPage")}</p>
                            <p className="text-sm text-muted-foreground">
                              {t("addToBioDesc")}
                            </p>
                          </div>
                        ...
                        <div className="pl-11">
                          ...
                          >
                            <SelectTrigger className="w-full">
                              <SelectValue placeholder={t("selectBioPage")} />
                            </SelectTrigger>
                            <SelectContent>
                              {bioPages.map((page) => (
              ...
              <CollapsibleTrigger className="w-full">
                <div className="flex items-center justify-between p-5 hover:bg-slate-50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-semibold">{t("advancedSettings")}</h2>
                  </div>
                ...
                <div className="px-5 pb-5 space-y-5 border-t pt-5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="utmSource">{t("source")}</Label>
                        <Input
                          id="utmSource"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="utmMedium">{t("medium")}</Label>
                        <Input
                          id="utmMedium"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="utmCampaign">{t("campaign")}</Label>
                        <Input
                          id="utmCampaign"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        type="password"
                        id="password"
                        placeholder={t("passwordPlaceholder").replace(" (optional)", "")}
                        {...register("password")}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger className="w-[200px]">
                        <SelectValue placeholder={t("selectRedirectType")} />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="deepLinkFallback"
                      placeholder={t("deepLinkFallbackPlaceholder")}
