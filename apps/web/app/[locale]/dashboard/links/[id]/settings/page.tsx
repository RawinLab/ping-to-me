  ...
  if (!link) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
        ...
        <p className="text-muted-foreground">{t("linkNotFound")}</p>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="302">{t("temporaryRedirect")}</SelectItem>
                    <SelectItem value="301">{t("permanentRedirect")}</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-xs text-muted-foreground">
                  {t("redirectTypeHelp")}
              ...
              {/* Status */}
              <div className="space-y-2">
                <Label htmlFor="status">{t("linkStatus")}</Label>
                <Select
