...
const developerNavItems = [
  ...
  { title: "webhooksTitle", href: "/dashboard/developer/webhooks", icon: Webhook },
];
...
export default function ApiKeysPage() {
  ...
  const handleRotateKey = async () => {
    ...
    try {
      ...
      alert(error.message || t("failedToRotateApiKey"));
    } finally {
      setRotating(false);
    }
  };
  ...
  const handleUpdateExpiration = async () => {
    ...
    try {
      ...
      alert(error.message || t("failedToUpdateExpiration"));
    } finally {
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-500">{t("loadingApiKeys")}</p>
        </div>
      </div>
    );
  }
            ...
            <Card className="border-slate-200 shadow-sm overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-slate-50 to-white border-b border-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <CardTitle className="text-lg">{t("yourApiKeys")}</CardTitle>
                    <CardDescription>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-slate-50/50">
                        ...
                        <TableHead className="font-semibold">{t("scopes")}</TableHead>
                            ...
                            {key.rateLimit && (
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-xs">
                                      {key.rateLimit} {t("requestsPerMinute")}
                                    </p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                            ...
                            <div className="flex items-center justify-end gap-1">
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-xs">{t("rotateApiKey")}</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-xs">{t("setExpiration")}</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-xs">{t("revokeApiKey")}</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                            </div>
            ...
            <Card className="border-slate-200 shadow-sm overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-slate-50 to-white border-b border-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <CardTitle className="text-lg">{t("quickStartGuide")}</CardTitle>
                    <CardDescription>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-4 bg-amber-50 rounded-xl">
              ...
              <div>
                <p className="font-medium text-amber-800 text-sm">{t("warning")}</p>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              {t("setApiKeyExpiration")}
            </DialogTitle>
            <DialogDescription>
              {t("setExpirationDescription")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
          ...
          <DialogFooter className="gap-2">
            ...
            <Button
              ...
              className="rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
            >
              {updatingExpiration ? t("updating", { defaultValue: "Updating..." }) : t("updateExpiration", { defaultValue: "Update Expiration" })}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
