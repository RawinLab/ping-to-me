          ...
          <CardContent className="p-6">
            ...
            <div className="flex items-center gap-6 mt-4 pt-4 border-t border-slate-100">
              ...
              {campaign.goalType && campaign.goalTarget && (
                <div className="flex items-center gap-2 text-sm text-slate-500">
                  ...
                  Goal: {campaign.goalTarget.toLocaleString()} {campaign.goalType}
                </div>
              )}
              <div className="flex items-center gap-2 text-sm text-slate-500">
            ...
            {(campaign.utmSource || campaign.utmMedium || campaign.utmCampaign) && (
              <div className="mt-4 pt-4 border-t border-slate-100">
                <p className="text-xs font-medium text-slate-500 mb-2">UTM Parameters</p>
          ...
          <Card className="overflow-hidden border-0 shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="space-y-1">
                ...
                <p className="text-sm text-slate-500">
                  {totalClicks > 0 ? Math.round((uniqueClicks / totalClicks) * 100) : 0}% of total
                </p>
              </div>
            </CardContent>
          </Card>
