...
export default function TagsPage() {
  ...
  const handleMerge = async () => {
    if (!sourceTagId || !targetTagId) {
      setError("Please select both source and target tags");
      return;
    }
    ...
    try {
      ...
      setError(error?.message || "Failed to merge tags");
    } finally {
      setSubmitLoading(false);
    }
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-slate-500 mt-1">
              Organize and categorize your links with tags.
            </p>
          </div>
          <div className="flex gap-2">
            <Dialog open={mergeDialogOpen} onOpenChange={setMergeDialogOpen}>
              <DialogTrigger asChild>
                ...
                >
                  <GitMerge className="mr-2 h-4 w-4" /> Merge Tags
                </Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Combine two tags by moving all links from source tag to
                    target tag.
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                        ...
                        {tags.map((tag) => (
                          <SelectItem key={tag.id} value={tag.id}>
                            <div className="flex items-center gap-2">
                              ...
                              />
                              {tag.name} ({getLinkCount(tag)} links)
                            </div>
                          </SelectItem>
                        ))}
                      </SelectContent>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="target-tag" className="text-slate-700 font-medium">
                      Target Tag (will receive all links)
                    </Label>
                ...
                <DialogFooter className="gap-2">
                  ...
                  >
                    {submitLoading ? "Merging..." : "Merge Tags"}
                  </Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
            <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Create a new tag to categorize your links.
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  {error && (
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-600">Total Tags</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-600">Used Tags</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-600">Unused Tags</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="py-16">
              <div className="text-center">
                ...
                <p className="text-slate-500 mb-6 max-w-sm mx-auto">
                  Create your first tag to start categorizing and organizing
                  your links.
                </p>
                <Dialog
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <DialogFooter className="gap-2">
              ...
              <Button
                ...
                className="rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
              >
                {submitLoading ? "Updating..." : "Update Tag"}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
        ...
        <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <AlertDialogContent>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mt-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="text-sm text-amber-800">
                          This tag is used by {getLinkCount(deletingTag)} {getLinkCount(deletingTag) === 1 ? "link" : "links"}.
                          The tag will be removed from all links, but the links will not be deleted.
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <AlertDialogFooter>
              ...
              >
                {submitLoading ? "Deleting..." : "Delete Tag"}
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
