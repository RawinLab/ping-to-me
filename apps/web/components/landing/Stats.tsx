const stats = [
  {
    value: "10M+",
    label: "Links created",
    description: "Short links generated by our users",
  },
  {
    value: "500M+",
    label: "Clicks tracked",
    description: "Total clicks tracked on our platform",
  },
  {
    value: "50K+",
    label: "Active users",
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
          ...
          <p className="max-w-[600px] text-slate-400 md:text-lg">
            Powering links, dashboards, and integrations worldwide. We are
