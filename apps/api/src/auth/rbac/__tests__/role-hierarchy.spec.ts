...
describe('RoleHierarchy', () => {
  ...
  describe('isRoleAtLeast()', () => {
    ...
    describe('Invalid roles', () => {
      ...
      it('should return false when both roles are invalid', () => {
        expect(isRoleAtLeast('INVALID1' as MemberRole, 'INVALID2' as MemberRole)).toBe(false);
      });
    });
  });
  ...
  describe('isRoleAbove()', () => {
    ...
    describe('Invalid roles', () => {
      ...
      it('should return false when both roles are invalid', () => {
        expect(isRoleAbove('INVALID1' as MemberRole, 'INVALID2' as MemberRole)).toBe(false);
      });
    });
  });
  ...
  describe('canManageRole()', () => {
    ...
    describe('Invalid roles', () => {
      ...
      it('should return false when both roles are invalid', () => {
        expect(canManageRole('INVALID1' as MemberRole, 'INVALID2' as MemberRole)).toBe(false);
      });
    });
  });
