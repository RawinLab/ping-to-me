...
test.describe("Role-Based Access Control", () => {
  test.describe("OWNER Role", () => {
    test("RBAC-001: OWNER can access organization settings", async ({
      page,
    }) => {
      // 1. Login as OWNER
  ...
  test.describe("ADMIN Role", () => {
    test("RBAC-010: ADMIN can access limited organization settings", async ({
      page,
    }) => {
      // 1. Login as ADMIN
      // 2. Navigate to organization settings
    ...
    test("RBAC-012: ADMIN cannot access billing management", async ({
      page,
    }) => {
      // 1. Login as ADMIN
  ...
  test.describe("EDITOR Role", () => {
    test("RBAC-020: EDITOR cannot access organization settings", async ({
      page,
    }) => {
      // 1. Login as EDITOR
    ...
    test("RBAC-025: EDITOR can view organization analytics", async ({
      page,
    }) => {
      // 1. Login as EDITOR
  ...
  test.describe("API Token Scopes", () => {
    test("RBAC-050: API key with read scope cannot write", async ({
      request,
    }) => {
    ...
    test("RBAC-051: API key with write scope can create", async ({
      request,
    }) => {
    ...
    test("RBAC-052: API key respects organization scope", async ({
      request,
    }) => {
