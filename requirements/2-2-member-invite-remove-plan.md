...
test.describe('Member Invitation', () => {
  ...
  test.describe('Accept Invitation', () => {
    ...
    test('MIR-013: Cannot accept already accepted invitation', async ({ page }) => {
  ...
  test.describe('Decline Invitation', () => {
    ...
    test('MIR-021: Cannot decline already declined invitation', async ({ page }) => {
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  <p style="color: #999; font-size: 12px;">
    This email was sent by PingTO.Me. If you didn't expect this invitation,
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  <p>
    You no longer have access to the organization's links, analytics,
    and other resources.
  </p>
